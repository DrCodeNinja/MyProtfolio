...
import profilePic from "../../public/images/profile/profile_vamshi_crop.png";
    ...
    <>
      ...
      <main className="flex items-center w-full min-h-screen text-dark dark:text-light">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="flex flex-col items-center self-center w-1/2 lg:w-full lg:text-center">
              <AnimatedText
                text={"Turning Vision Into Reality With Code And Testing."}
                className="!text-6xl text-left xl:!text-5xl lg:!text-center lg:!text-5xl md:!text-5xl sm:!text-3xl"
              />
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As a skilled  Software Test Engineer, I am dedicated to turning
                ideas into innovative web applications Testing . Explore my latest
                projects and articles, showcasing my expertise in  Manul testing and
                Automation Testing!
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link
                  href="vamshikrishanapolepu@gmail.com"
                  target="_blank"
        ...
        <div className="absolute inline-block w-24 right-8 bottom-8 md:hidden">
          <Image src={lightBulb} alt="vamshi  tester" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
